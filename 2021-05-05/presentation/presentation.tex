...
\section{Big Data}
\begin{frame}{}
Working with big data\vspace{\baselineskip}\\
{
\centering
\includegraphics[width=\textwidth]{images/dask-dataframe.png}
}
\end{frame}
...
\section{Forecasting}
\begin{frame}{}
ARMA processes\vspace{\baselineskip}\\
{
\centering
...
Read in some big data and make some forecasts. Next week we can check our forecasts.
\end{block}
