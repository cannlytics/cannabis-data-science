...
def cannabinoid_histogram(series, title, y_label, x_label):
...
# Identify all flower samples with Delta-8 THC.
delta_8_thc = flower_data.loc[flower_data.cannabinoid_d8_thc_percent > 0]
print('Number of flower samples with Delta-8 THC: %i' % len(delta_8_thc))
