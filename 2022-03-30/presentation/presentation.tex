...
\item Machine--independent programming languages.

\item First compiler in 1952, the A-0 system.
...
John Von Neumann founded the field of {\bfseries game theory} as a mathematical discipline.

\begin{itemize}

\item {\itshape Theory of Games and Economic Behavior}, Von Neumann and Morgenstern (1944).

\item Savage extended von Neumann and Morgenstern's axioms of rational preferences to endogenize probability and make it subjective. He then used Bayes' theorem to update these subject probabilities in light of new information, thus linking rational choice and inference.
