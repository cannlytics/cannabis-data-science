...
\section{Big Data}
\begin{frame}{}
Does rainfall have an effect on cannabinoid results?\vspace{\baselineskip}\\
\begin{center}
\includegraphics[width=0.75\textwidth]{images/rainfall_map.jpg}
\end{center}
{\tiny Map courtesy www.wamaps.com}
\end{frame}
...
Try some dummy variable regressions on your own to uncover any statistical differences between Eastern and Western Washington.
\end{block}
