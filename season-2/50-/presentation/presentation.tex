...
% Title
%------------------------------------------%
\title[\textbf{Cananbis Data Science \#50}]{}
\author{Cannabis Data Science}
\institute[]{\Large Cananbis Data Science \#50}
\date{January \nth{25}, 2022}
...
Are there any cultivation patterns that can be discovered from augmenting and visualizing cultivation data?
...
\item It is imperative to have the right tools for the task at hand.

\vspace{\baselineskip}

\item A little data augmentation and visualization can go a long way.
