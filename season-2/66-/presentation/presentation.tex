...
% Title
%------------------------------------------%
\title[\textbf{Cannabis Data Science \#66}]{}
\author{Cannlytics}
\institute[]{\Large Cannabis Data Science \#66}
\date{May \nth{25}, 2022}
...
\begin{frame}{Cannabis + Intellectual Property + Data Science}

\small

\begin{itemize}

\item {\bfseries Plant Patent Act of 1930}.

\begin{itemize}

\item Spurred by {\bfseries Luther Burbank}.

\vspace{0.5\baselineskip}

\item Possible to patent new varieties of plants, excluding sexual and tuber-propagated plants.

\end{itemize}

%\item {\bfseries Plant Variety Protection Act of 1970}.
%
%\begin{itemize}
%
%\item Gives breeders up to 25 years of exclusive control over new, distinct, uniform, and stable sexually reproduced or tuber propagated plant varieties.
%
%\end{itemize}
...
\begin{figure}
\includegraphics[height=2in]{images/burbank.jpg}
\end{figure}
\end{minipage}\hspace{0.05\textwidth}%
\begin{minipage}{.45\textwidth}
\begin{figure}
\includegraphics[height=2in]{images/burbank-book.jpg}
\end{figure}
\end{minipage}
...
\item Big things can grow come from small seeds.
