...
% Title
%------------------------------------------%
\title[\textbf{Cannabis Data Science \#69}]{}
\author{Cannlytics}
\institute[]{\Large Cannabis Data Science \#69}
\date{June \nth{8}, 2022}
...
\begin{figure}
\includegraphics[width=\textwidth]{images/jack-herer-painting.jpg}
\end{figure}
...
%
%\begin{figure}
%\includegraphics[width=\textwidth]{images/sunset.jpg}
%\end{figure}
%
%\end{frame}
...
\begin{figure}
\includegraphics[width=\textwidth]{images/law-of-large-numbers.png}
\end{figure}
...
\begin{figure}
\includegraphics[width=\textwidth]{images/super-sport-label-2.jpg}
\end{figure}
\end{minipage}\hspace{0.05\textwidth}%
\begin{minipage}{0.45\textwidth}
\begin{figure}
\includegraphics[width=\textwidth]{images/super-sport-label.jpg}
\end{figure}
\end{minipage}
