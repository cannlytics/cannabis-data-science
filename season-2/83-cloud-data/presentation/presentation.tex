...
% Title
%------------------------------------------%
\title[\textbf{Cannabis Data Science \#83}]{}
\author{Cannlytics}
\institute[]{\Large Cannabis Data Science \#83}
\date{September \nth{14}, 2022}
...
\vspace{0.75\baselineskip}
\item {\bfseries Start} somewhere.

\vspace{0.75\baselineskip}

\item The place where you begin\newline {\bfseries doesn't have to be perfect}.

\vspace{0.75\baselineskip}

\item {\bfseries Continuously improve}.
