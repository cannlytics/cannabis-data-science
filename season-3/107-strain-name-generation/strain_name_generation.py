"""
Pre-training NLP models with transformers
...
Original author (unaffiliated): [Matthew Watson](https://github.com/mattdangerw/)
Original license: <https://github.com/keras-team/keras-io/blob/master/LICENSE>

Description:

    Can we build an AI model that can predict successful strain names?

Reference:

    - Keras Transformer Pre-training
    URL: <https://github.com/keras-team/keras-io/blob/master/guides/keras_nlp/transformer_pretraining.py>

Setup:

    pip install keras-nlp==0.4.1 --user
...
# Specify strain vocabulary.
strain_vocab_file = 'strain-vocab.txt'

# TODO: Substitute strain vocabulary.
...
# Save this base model for further fine-tuning.
...
inference_data = tf.constant(["Jack Herer", "Gorilla Glue"])
