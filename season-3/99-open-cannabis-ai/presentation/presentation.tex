...
% Title
%------------------------------------------%
\title[\textbf{Cannabis Data Science \#99}]{}
\author{Cannlytics}
\institute[]{\Large Cannabis Data Science \#99}
\date{February \nth{8}, 2023}
...
\begin{frame}{From Homegrow to Homebaking}

\begin{center}
\includegraphics[height=2.75in]{images/cake.png}
