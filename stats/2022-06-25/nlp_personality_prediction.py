...
# Given someone's personality traits or a corpus of their writing,
# the model can predict the average beta-pinene to d-limonene ratio
# that the user would gravitate towards on average. When a user
# visits a new dispensary, then for convenience they know to ask their
# budtender for a "Sativa" if the ratio is greater than roughly 0.25
# and ask for an "Indica" otherwise.
